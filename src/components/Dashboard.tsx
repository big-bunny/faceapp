  ...
  render() {
    return (
      <div className="min-h-screen p-8">
        <h1 className="text-4xl  text-white font-extrabold  bg-gradient-to-r from-red-500 rounded-full mb-8">Welcome to Schield Centre Dashboard</h1>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col mr-8">
            ...
            <div className="scrolling-text mb-4 text-center bg-white rounded-3xl">
              ...
              <p className="text-xl text-black">Our mission is to provide access to quality education to children in Kajiado, Kenya, with the aim of empowering them to break the cycle of poverty and improve their lives and those of their families. We strive to create a learning environment that is supportive, inclusive, and empowering, valuing diversity and embracing the unique cultural heritage of our community.</p>
            </div>
